...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8">
        <title>Tansah - Coretan Kisah</title>
    ...
    <div class="container-fluid page-header py-5 mb-5">
        <div class="container py-5">
            ...
            <p class="text-white animated slideInDown">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Esse hic placeat,
                voluptates eum non natus quis vitae repellendus deserunt facilis assumenda animi
                aliquid facere! Id velit officia laudantium perferendis quo voluptatem
                consequatur laborum magni fuga, fugiat ipsum! Laborum, illo accusamus!
            </p>
        </div>
    </div>
    <!-- Page Header End -->
            ...
            <div class="row mt-n2 wow fadeInUp" data-wow-delay="0.3s">
                <div class="col-12 text-center">
                    <ul class="list-inline mb-5" id="portfolio-flters">
                        <li class="mx-2 active" data-filter="*">Romantis</li>
                        <li class="mx-2" data-filter=".first">Horror</li>
                        <li class="mx-2" data-filter=".second">Sejarah</li>
                    </ul>
                </div>
            </div>
            ...
            <div class="copyright">
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        &copy;
                        <a href="#">Tansah</a>, All Right Reserved.
                    </div>
                </div>
            </div>
        </div>
